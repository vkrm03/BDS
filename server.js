    ...
    try {
        if (currnt_role === "adm") {
            ...
            try {
                    currnt_Id = 1;
                    if (currnt_Id == 1) {
                        currnt_image_url = "./Mentees/alumini.jpg"
                    } 
                    if (pass === "password" && email === "vishalij99@gmail.com") {
...
app.get("/dashboard",checkAuth, async (req, res) => {
        ...
        res.render("staff-dashboard.ejs", {
            StaffName: "Vishalini J",
            StaffEmail: "vishalij99@gmail.com",
            StaffGender: "Female",
            StaffMobileNum: "+91 9500093896",
            StaffHandling: "senior software Engineer",
